...
# ==========================================
# /start Command စမ်းသပ်ရန်
# ==========================================
@bot.message_handler(commands=['start'])
def send_welcome(message):
    bot.reply_to(message, "✅ Wingo AI Predictor Pro စတင်အလုပ်လုပ်နေပါပြီ။ ၁ မိနစ်တစ်ခါ အလိုအလျောက် ခန့်မှန်းချက် ပို့ပေးပါမည်။")
...
# ==========================================
# အလိုအလျောက် ပို့ပေးမည့် Loop & Bot Polling
# ==========================================
def auto_prediction_sender():
    ...
    while True:
        try:
            ...
            print("Predictions successfully broadcasted.")
        except Exception as e:
...
if __name__ == "__main__":
    # စာအလိုအလျောက်ပို့မည့် Thread
    sender_thread = Thread(target=auto_prediction_sender)
    sender_thread.daemon = True
    sender_thread.start()
    
    # Bot စကားပြောနားထောင်မည့် Polling Thread
